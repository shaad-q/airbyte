...
def patch_base_class(mocker):
    ...
    mocker.patch.object(SyndigoStream, "path", "v0/example_endpoint")
    mocker.patch.object(SyndigoStream, "primary_key", "test_primary_key")
    mocker.patch.object(SyndigoStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = SyndigoStream()
